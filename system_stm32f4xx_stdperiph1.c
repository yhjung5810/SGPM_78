...
#if DISCOVERY
#define VECT_TAB_OFFSET  00 //!< Vector Table base offset field.
#else
#define VECT_TAB_OFFSET  0x4000 //!< Vector Table base offset field. // lji 150626 sector 1 relocation
#endif
...
#if defined (STM32F40_41xxx) || defined (STM32F427_437xx) || defined (STM32F429_439xx)			// lji 150323 
/* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */
#define PLL_M      25
#else 								//defined (STM32F411xE) || (STM32F401xx)
#if defined (USE_HSE_BYPASS)
#define PLL_M      8    
#else /* STM32F411xE */   
#define PLL_M      16
...
{
// #if defined (STM32F40_41xxx) || defined (STM32F427_437xx) || defined (STM32F429_439xx) || defined (STM32F401xx)
#if defined (STM32F40_41xxx) || defined (STM32F427_437xx) || defined (STM32F429_439xx)		// lji 20150323 
/******************************************************************************/
...
// #elif defined (STM32F411xE)
#elif defined (STM32F411xE)	|| defined (STM32F401xx)					// lji 150323 debugging 401 & 411 case
#if defined (USE_HSE_BYPASS) 
/******************************************************************************/
/*            PLL (clocked by HSE) used as System clock source                */
/******************************************************************************/
